...
public class ViolationsProductController {
    ...
    // Page<Object> result = violationsProductService.findProductWithFalse(Page,
    // 10);
    // return ResponseEntity.ok(result);
    // }

    // @GetMapping("/staff/alreadyviolationsproduct/{Page}")
    // public ResponseEntity<Page<Object>> getProductViolation(@PathVariable int
    // Page) {
    ...
    // public ResponseEntity<List<String>> getDescriptionByProductId(@PathVariable
    // int productId) {
    // List<String> result =
    // violationsProductService.getDescriptionByProductId(productId);
    // return ResponseEntity.ok(result);
    // }
    ...
    // public ResponseEntity<List<Object>> searchProductViolation(@RequestParam
    // String name) {
    // List<Object> searchResult =
    // violationsProductService.findSearchProducts(name);
    // return ResponseEntity.ok(searchResult);
    // }

    // @GetMapping("/staff/searchAlreadyViolationProduct")
    // public ResponseEntity<List<Object>>
    // searchAlreadyProductViolation(@RequestParam String name) {
    // List<Object> searchResult =
    // violationsProductService.findSearchViolationProducts(name);
    // return ResponseEntity.ok(searchResult);
    // }

    // @PostMapping("/staff/violationsproduct/accept/{productId}")
    // @Transactional
    // public ResponseEntity<Page<Object>> acceptProductViolations(@PathVariable int
    // productId) {
    ...
    // @Transactional
    // public ResponseEntity<Page<Object>> deleteProductViolations(@PathVariable int
    // productId) {
